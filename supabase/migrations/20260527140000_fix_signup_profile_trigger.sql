...
-- Common cause: profiles.link_code NOT NULL but handle_new_user still omits link_code,
-- or seed_mastery trigger fails and rolls back the auth insert.
...
-- Seed mastery must not roll back signup
...
-- Default class for guides (non-fatal on failure)
